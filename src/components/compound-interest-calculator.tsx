      ...
      <ScrollArea className="w-full lg:w-1/3 lg:pr-4">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormField control={form.control} name="dailyInterest" render={({ field }) => (
                <FormItem>
            ...
            <FormField control={form.control} name="reinvest" render={({ field }) => (
                <FormItem>
            ...
            <div className="grid grid-cols-2 gap-4">
                <FormField control={form.control} name="monthlyContributionType" render={({ field }) => (
                    <FormItem>
                ...
                <FormField control={form.control} name="monthlyContributionValue" render={({ field }) => (
                    <FormItem>
                    <FormLabel>&nbsp;</FormLabel>
                    <FormControl>
                        <Input type="number" {...field} disabled={form.watch('monthlyContributionType') === 'none'} onChange={e => field.onChange(parseFloat(e.target.value) || 0)} />
                    </FormControl>
                    </FormItem>
                )} />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
                <FormField control={form.control} name="oneTimeTopOff" render={({ field }) => (
                    <FormItem>
                ...
                <FormField control={form.control} name="oneTimeTopOffDate" render={({ field }) => (
                    <FormItem>
          ...
          <div className='flex-1 flex flex-col min-h-0'>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 text-center">
                ...
                <div>
                    ...
                    <p className="text-lg font-bold text-green-600">{symbol}{summary.totalInterest.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>
                <div>
                    <h3 className="text-sm text-muted-foreground">Final Balance</h3>
                    <p className="text-lg font-bold">{symbol}{summary.finalBalance.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>
            </div>
            ...
            <Tabs defaultValue="daily" className="flex-1 flex flex-col min-h-0">
                ...
                <ScrollArea className="flex-1 mt-2">
                    ...
                    <TabsContent value="weekly"><BreakdownTable data={weeklyBreakdown} symbol={symbol} period="Week" /></TabsContent>
                    <TabsContent value="monthly"><BreakdownTable data={monthlyBreakdown} symbol={symbol} period="Month" /></TabsContent>
                    <TabsContent value="yearly"><BreakdownTable data={yearlyBreakdown} symbol={symbol} period="Year" /></TabsContent>
                </ScrollArea>
            </Tabs>
          </div>
        ) : (
